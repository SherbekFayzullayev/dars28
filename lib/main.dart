      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Switch(value: a, onChanged: fn)),
              ],
            ),
            Container(
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    ...
                    child: Switch(value: a1, onChanged: fn1)),
              ],
            ),
            Container(
            ...
            Container(
              margin: const EdgeInsets.only(right: 330, bottom: 10),
              child: const Text(
                'Single check',
                style: TextStyle(color: Colors.black, fontSize: 25),
              ),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    margin: EdgeInsets.only(right: 10),
                    child: Radio(value: 'a', groupValue: ab, onChanged: fnb)),
              ],
            ),
            Container(
              margin: const EdgeInsets.only(top: 20, bottom: 20),
            ...
            Row(
              ...
              children: [
                ...
                Container(
                    margin: const EdgeInsets.only(right: 10),
                    child: Radio(value: 'ab', groupValue: ab, onChanged: fnb)),
              ],
            ),
            Container(
              margin: const EdgeInsets.only(top: 20, bottom: 20),
            ...
            Container(
              margin: const EdgeInsets.only(right: 320, bottom: 10),
              child: const Text(
                'Multiple check',
                style: TextStyle(fontSize: 23),
              ),
